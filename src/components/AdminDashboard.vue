                  ...
                  <template v-slot:body-cell-estado="props">
                     <q-td :props="props">
                        <span :class="{
                           ...
                           {{ new Date(props.row.fecha_cierre) < new Date() ? 'Cerrada' : (new
                              Date(props.row.fecha_inicio) > new Date() ? 'Próxima' : 'Activa') }}
                        </span>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
               ...
               <div class="p-6 border-b border-gray-100 bg-gray-50/50">
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                     <q-select v-model="filtroConvocatoria" :options="convocatoriasOptions" label="Convocatoria"
                     ...
                     <q-select v-model="filtroCargo" :options="cargosOptions" label="Cargo" outlined dense
               ...
               <q-table :rows="postulaciones" :columns="postulacionesColumns" row-key="id" flat
                  ...
                  <template v-slot:body-cell-estado="props">
                     <q-td :props="props">
                        <q-select :model-value="props.row.estado" :options="estadosOptions" dense outlined
                           class="text-xs" bg-color="white" emit-value map-options
                     ...
                     <div class="max-w-3xl mx-auto py-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                           ...
                           <div class="col-span-2">
                              ...
                              <q-input v-model="convocatoriaForm.descripcion" outlined dense type="textarea"
                                 bg-color="white" rows="3" />
                           </div>
                           <div>
                              <label class="block text-sm font-medium text-gray-700 mb-1">Fecha Inicio <span
                                    class="text-red-500">*</span></label>
                              <q-input v-model="convocatoriaForm.fecha_inicio" outlined dense type="date"
                                 bg-color="white" />
                           </div>
                           <div>
                              <label class="block text-sm font-medium text-gray-700 mb-1">Fecha Cierre <span
                                    class="text-red-500">*</span></label>
                              <q-input v-model="convocatoriaForm.fecha_cierre" outlined dense type="date"
                                 bg-color="white" />
                           </div>
                           <div
                              class="col-span-2 bg-blue-50 p-4 rounded-xl text-blue-800 text-sm flex items-center gap-3">
                        ...
                        <div class="flex justify-end mt-12 pt-6 border-t border-gray-100">
                           ...
                           <button v-else
                              @click="() => { if (convocatoriaForm.titulo && convocatoriaForm.fecha_inicio && convocatoriaForm.fecha_cierre) step = 2; else $q.notify({ type: 'warning', message: 'Complete los campos obligatorios' }) }"
                     ...
                     <div class="max-w-4xl mx-auto py-4">
                        ...
                        <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm mb-6">
                           ...
                           <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
                              ...
                              <div class="md:col-span-4 flex gap-2 items-start">
                                 <div class="flex-1">
                                    <q-select v-model="tempOferta.sede_id" :options="sedesOptions" label="Sede" outlined
                                       dense bg-color="white" emit-value map-options class="w-full">
                              ...
                              <div class="md:col-span-5 flex gap-2 items-start">
                                 <div class="flex-1">
                                    <q-select v-model="tempOferta.cargos_ids" :options="cargosOptions" label="Cargos"
                                       outlined dense bg-color="white" emit-value map-options multiple use-chips
                                       stack-label class="w-full">
                                       <template v-slot:no-option>
                              ...
                              <div v-if="tempOferta.cargos_ids.length > 0"
                                 ...
                                 <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div v-for="id in tempOferta.cargos_ids" :key="id"
                                       ...
                                       <q-input v-model.number="tempOferta.vacantes_map[id]" type="number" outlined
                                          dense bg-color="white" style="width: 80px" min="1" />
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm min-h-[200px]">
                           ...
                           <table v-else class="w-full text-left">
                              <thead
                                 class="bg-gray-50 text-gray-500 uppercase text-xs font-semibold border-b border-gray-100">
                                 <tr>
               ...
               <div class="max-w-6xl mx-auto space-y-8">
                  ...
                  <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm relative overflow-hidden">
                     ...
                     <div class="flex items-center justify-between mb-6">
                        ...
                        <div
                           class="text-xs font-bold text-gray-400 bg-gray-50 px-2 py-1 rounded uppercase tracking-wider">
                           Acción Rápida</div>
                     </div>
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                        ...
                        <div class="md:col-span-4 space-y-1.5">
                           ...
                           <div class="flex gap-2">
                              <q-select v-model="nuevaOferta.sede_id" :options="sedesOptions" outlined dense
                                 bg-color="white" emit-value map-options class="flex-1" placeholder="Seleccione Sede">
                                 <template v-slot:no-option>
                        ...
                        <div class="md:col-span-5 space-y-1.5">
                           <label class="text-xs font-bold text-gray-500 uppercase ml-1">Cargos (Selección
                              Múltiple)</label>
                           <div class="flex gap-2">
                              <q-select v-model="nuevaOferta.cargos_ids" :options="cargosOptions" multiple use-chips
                                 stack-label outlined dense bg-color="white" emit-value map-options class="flex-1"
                        ...
                        <div class="md:col-span-3">
                           <div class="flex gap-3 h-full">
                              <div class="flex-none space-y-1.5 w-24">
                                 ...
                                 <q-input v-model="nuevaOferta.vacantes" type="number" outlined dense bg-color="white"
                                    min="1" />
                              </div>
                  ...
                  <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                     <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                        ...
                        <span
                           class="px-2.5 py-1 bg-white border border-gray-200 rounded-lg text-xs font-bold text-gray-500">
      ...
      <q-dialog v-model="showExpedienteDialog" maximized transition-show="slide-up" transition-hide="slide-down">
         <div class="bg-gray-50 min-h-screen flex flex-col">
            <div
               ...
               <button @click="showExpedienteDialog = false" class="p-2 hover:bg-gray-100 rounded-full"><q-icon
